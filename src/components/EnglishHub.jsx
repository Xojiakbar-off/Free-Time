  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="flex gap-3 mt-4">
        <button onClick={()=>speak(card.word)} className="flex-1 py-3 rounded-xl bg-slate-900/5 text-slate-700 text-sm font-medium hover:bg-slate-900/10 dark:bg-white/10 dark:text-slate-300 dark:hover:bg-white/20"><Volume2 size={14}/> Pronounce</button>
